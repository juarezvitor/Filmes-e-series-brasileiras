let dados = [    
    {
        titulo : "Pedro Dom",
        descricao : " é uma série brasileira que mergulha na complexa relação entre um pai e um filho, ambos marcados pelo mundo do crime. A trama se baseia em fatos reais e acompanha a vida de Pedro Dom, um jovem que se torna um dos maiores criminosos do Rio de Janeiro, e de seu pai, Victor Lomba, um policial que dedica sua vida à luta contra as drogas",
        link : "https://www.primevideo.com/-/pt/detail/DOM/0RXMEPPBWG40PBHLDFG8E8QJKN",
        linkcritica : "https://www.omelete.com.br/series-tv/criticas/dom-3-temporada-critica",
        tags: "policia policial playboy "
    },
    {
        titulo : "Cangaço Novo",
        descricao : " é uma série brasileira que reinventa o clássico mito do cangaço, transportando-o para os dias atuais. A trama acompanha Ubaldo, um bancário insatisfeito com sua vida em São Paulo, que descobre ser herdeiro de uma família do sertão cearense com um passado ligado ao famoso movimento de bandidos.",
        link : "https://www.primevideo.com/dp/amzn1.dv.gti.a00fdab6-1391-4871-a0b2-5be765193506?autoplay=0&ref_=atv_cf_strg_wb",
        linkcritica : "https://www.omelete.com.br/series-tv/criticas/cangaco-novo-1a-temporada",
        tags: "policia"
    },
    {
        titulo: "Largados e Pelados Brasil",
        descricao: " Dez brasileiros enfrentam o desafio de sobreviver por 21 dias na selva amazônica, sem comida, água ou abrigo. A série acompanha a jornada desses participantes enquanto lutam contra a natureza selvagem e seus próprios limites.",
        link: "https://www.max.com/br/pt/shows/largados-e-pelados-brasil-a-reuniao/0666f06b-6d69-4e7c-aefa-9b03892d8f9b?utm_source=universal_search",
        linkcritica: "",
        tags: "sobrevivencia mato floresta desafio brasil"
      },
      {
        titulo: "Sob Pressão",
        descricao: " Uma série dramática que acompanha o dia a dia de uma equipe médica de um hospital público no Rio de Janeiro, mostrando os desafios e as emoções de salvar vidas em um sistema de saúde sobrecarregado.",
        link: "https://globoplay.globo.com/sob-pressao/t/PhQ7Wtzn6C/?origemId=91698",
        linkcritica: "https://www.adorocinema.com/filmes/filme-250199/criticas-adorocinema/",
        tags: "carioca "
      },
      {
        titulo: "Arcanjo Renegado",
        descricao: " Uma série de ação que acompanha a história de Miguel, um ex-militar que se torna um justiceiro, combatendo a corrupção e o crime organizado.",
        link: "https://globoplay.globo.com/arcanjo-renegado/t/jqvngb9dQG/?origemId=91698",
